      ...
      >
        <nav class="px-4 py-6 space-y-1 text-sm">
             <!-- ASSIGNACIONS -->
              ...
              <!-- ALUMNAT -->
              <div>
                <p class="px-3 py-1 text-xs uppercase text-gray-500 tracking-wide">
                  Alumnat
                </p>
                ...
                <ul class="mt-2 space-y-1 max-h-[60vh] overflow-y-auto">
                  ...
                  >
                    <button
                      ...
                      :class="{
                        'bg-gray-200 font-medium': student.id === selectedStudentId
                      }"
          ...
          <table class="w-full text-sm">
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  <span v-if="student.teacher">{{ student.teacher.username }}</span>
...
onMounted(async () => {
  const response = await $fetch("http://localhost:3000/admin/assignments") as any;
...
async function saveAssignment() {
  await $fetch(`http://localhost:3000/admin/assignments/${selectedStudent.value.id}`, {
    method: "PATCH",
    body: {
